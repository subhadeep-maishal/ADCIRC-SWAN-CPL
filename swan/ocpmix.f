...
!Casey 160728: Merging the changes from Jason in an earlier version of SWAN.
            ! jgf52.30.05: Provide a more comprehensive workaround for    41.20 
            ! the issue where ADCIRC opens a file using a unit number     41.20
            ! that SWAN is already using. The long term solution here     41.20
            ! is to have ADCIRC check the unit numbers it is opening      41.20
            ! to see if they are already in use.                          41.20
            !                                                             41.20
            ! FIXME: We still might collide with NWS11, if anyone         41.20
            ! still uses that.                                            41.20
            SELECT CASE(IFUN)                                             41.20
            CASE(10:93,98,101,102,111,141,151,164,199,200)                41.20
               GOTO 60                                                    41.20
            CASE(221:224,225,227,301:307,311:322,323,333,400:404,667)     41.20
               GOTO 60                                                    41.20
            CASE(1019:1021,1065:1067)                                     41.20
               GOTO 60                                                    41.20
            CASE DEFAULT                                                  41.20
               CONTINUE                                                   41.20
            END SELECT                                                    41.20
