...
!
      ...
      USE SWCOMM3                                                         40.41
      USE SWCOMM4                                                         40.41
      USE WIND, ONLY: WindDrag                                            41.20
!MVB
      USE Couple2Swan, ONLY: ComputeSwanWindDrag
!
      IMPLICIT NONE
!
!
...
!***********************************************************************
!
      INTEGER, OPTIONAL :: NodeNumber                                     41.20
!
...
!       added the default option to use the ADCIRC drag formulation
        IF ( IDRAG.EQ.0 ) THEN
           IF ( WIND10 .GT. 7.5 ) THEN
              CDRAG = WindDrag(DBLE(WIND10),NodeNumber)
           ELSE
              CDRAG = 0.0012873
           ENDIF
        ENDIF
...
!
      ...
      END IF
! MVB
        CALL ComputeSwanWindDrag(CDRAG,NodeNumber)
!
!
!     *** test output ***
!
