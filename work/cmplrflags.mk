...
ifeq ($(compiler),intel)
  ...
  ifeq ($(NETCDF),enable)
     ifeq ($(MACHINENAME),hatteras)
        FLIBS       := $(FLIBS) -L/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5/lib -lnetcdff -lnetcdf
        NETCDFHOME    :=/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5
        FFLAGS1       :=$(FFLAGS1) -I/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5/include
        FFLAGS2       :=$(FFLAGS1)
        FFLAGS3       :=$(FFLAGS1)
     endif
     ...
     ifeq ($(MACHINENAME),spirit) 
        NETCDFHOME :=/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5
        FLIBS      := $(FLIBS) -L/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5/lib -L$(NETCDFHOME)/lib -L/home/20cl91p02/NEXTGEN/LIB_INSTALL/NETCDF4_HDF5/lib -lnetcdff -lnetcdf
     endif
